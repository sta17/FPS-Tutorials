extends Player
class_name PlayerThirdPersonMixamo
...
@onready var rightHand: BoneAttachment3D = $Armature/Skeleton3D/RightHand
@onready var leftHand: BoneAttachment3D = $Armature/Skeleton3D/LeftHand
